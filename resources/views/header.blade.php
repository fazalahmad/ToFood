			...
			<div class="sidebar-scroll">
				...
				<nav id="left-sidebar-nav" class="sidebar-nav">
					<ul id="main-menu" class="metismenu">
						...
						<li class="">
							<a href="#uiElements" class="has-arrow" aria-expanded="false"><i class="lnr lnr-magic-wand"></i> <span>Barang</span></a>
							<ul aria-expanded="true">
								<li class=""><a href="tambah">Add</a></li>
								<li class=""><a href="#">Out</a></li>
							</ul>
						</li>
